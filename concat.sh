cat "1. CKD_codes.sql" > whole_script.sql
...
cat "5.3 AKD.sql" >> whole_script.sql
cat "5.4 CKD.sql" >> whole_script.sql
cat "5.5 Other_KD.sql" >> whole_script.sql
cat "6.0 Phenotype.sql" >> whole_script.sql
