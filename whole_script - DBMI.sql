...
INSERT INTO #UrineTestCloseToRntGfr
    SELECT
      G.person_id,
...
INSERT INTO #UrineTestCloseToRntGfr2 
...
LEFT JOIN (SELECT * FROM #UrineTestCloseToRntGfr2 WHERE rn =2) J2
...
FROM ohdsi_cumc_deid_pending.dbo.PERSON J
LEFT JOIN (
/* had a kidney transplant */
	SELECT subject_id
		,COUNT(DISTINCT cohort_start_date) AS transplantCnt
	FROM ohdsi_cumc_deid_pending.dbo.cohort
