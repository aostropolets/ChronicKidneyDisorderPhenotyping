...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (438624,4019967,45889365,4300837,4300838,4300839,45887996,4059475,4272012,4146536,4026915,4289454)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (438624,4019967,45889365,4300837,4300838,4300839,45887996,4059475,4272012,4146536,4026915,4289454)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (436375,132797,201965)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (436375,132797,201965)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (761083,37116430,37116431,37116432,4228827,4111399,4232873,40481064,197320,4126305,444044,37399017,42536547,37116834)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (761083,37116430,37116431,37116432,4228827,4111399,4232873,40481064,197320,4126305,444044,37399017,42536547,37116834)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (46271022,196991,193782,40769275,36716945,4030518)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4324887,4180454,42690461,2833286,2877118,4163566,4146256,4322471,42539502,4082531)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4324887,4180454,42690461,2833286,2877118,4163566,4146256,4322471,42539502,4082531)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (192279,201313,4128220,437992,4030518)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (192279,201313,4128220,437992,4030518)
  and c.invalid_reason is null
...
DELETE FROM @target_database_schema.@target_cohort_table where cohort_definition_id = @target_cohort_id; -- 1013
