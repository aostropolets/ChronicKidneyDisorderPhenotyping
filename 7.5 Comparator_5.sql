--C: dialysis OR CKD OR transplant (excluding acute states)_2
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (46271022,196991,193782,40769275,36716945)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
