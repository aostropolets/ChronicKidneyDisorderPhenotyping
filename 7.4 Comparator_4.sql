-- C: dialysis OR CKD OR transplant (excluding acute states)
...
DELETE FROM @target_database_schema.@target_cohort_table where cohort_definition_id = @target_cohort_id; -- hardcoded as 1010
